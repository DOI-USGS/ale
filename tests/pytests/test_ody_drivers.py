...
class test_themisir_isis_naif(unittest.TestCase):
    ...
    def test_start_time(self):
        with patch('ale.drivers.ody_drivers.NaifSpice.spiceql_call', return_value=0) as spice:
    ...
    def test_ephemeris_start_time(self):
        with patch('ale.drivers.ody_drivers.NaifSpice.spiceql_call', return_value=400001111.2222333) as scs2e:
...
class test_themisvis_isis_naif(unittest.TestCase):
    ...
    def test_ephemeris_start_time(self):
        with patch('ale.drivers.ody_drivers.NaifSpice.spiceql_call', return_value=392211096.4307215) as scs2e:
