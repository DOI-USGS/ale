...
def test_mro_hirise_load(test_hirise_kernels, label_type, kernel_type):
    ...
    isd_str = ale.loads(label_file, props={'kernels': test_hirise_kernels, 'remove_kernels': True}, verbose=True)
...
def test_mro_marci_load(test_marci_kernels, label_type, kernel_type):
    ...
    isd_str = ale.loads(label_file, props={'kernels': test_marci_kernels, 'remove_kernels': True})
...
def test_mro_crism_load(test_crism_kernels):
    ...
    isd_str = ale.loads(label_file, props={'kernels': test_crism_kernels, 'exact_ck_times': False, 'remove_kernels': True}, verbose=True)
    isd_obj = json.loads(isd_str)
