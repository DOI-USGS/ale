...
class test_data_naif(unittest.TestCase):
    ...
    def test_sensor_orientation(self):
        ...
        print("{:.20f}, {:.20f}, {:.20f}, {:.20f}".format(*orientation[0]))
        np.testing.assert_allclose(orientation[0], [0.0841049514805286, 0.0177248856361847, 0.9945886695651665, 0.0583572098222156])
