...
class test_pds_naif(unittest.TestCase):
    ...
    def test_utc_start_time(self):
        assert self.driver.utc_start_time == datetime.datetime(2009, 4, 5, 20, 9, 53, 607478)

    def test_utc_stop_time(self):
        assert self.driver.utc_stop_time == datetime.datetime(2009, 4, 5, 20, 10, 23, 864978)
