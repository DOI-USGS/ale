...
class Chandrayaan2OHRCIsisLabelNaifSpiceDriver(LineScanner, IsisLabel, NaifSpice, NoDistortion, Driver):
    ...
    def instrument_id(self):
        """
        Returns the instrument id for chandrayaan2 orbiter high resolution camera
        ...
        """
# TODO(oalexan1): Must fix all below.

        inst_id_lookup = {
            "OHRC" : "CHANDRAYAAN-2 Orbiter High Resolution Camera"
        }
        return inst_id_lookup[super().instrument_id]
    ...
    def ikid(self):
        ...
        -------
        : int
          ikid for chandrayaan2 orbiter high resolution camera
        """
        return self.label['IsisCube']['Kernels']['NaifFrameCode']
